...
You have identified the personas in our team, but we still need to structure it in some way. For that, we will make use of [Agile](https://agilemanifesto.org/).

[Extreme Programming](http://www.extremeprogramming.org/) (XP) and [Scrum](https://www.scrum.org/resources/what-is-scrum) are the best options. They are very alike. Scrum is more flexible when talking about code and development process, XP, on the other hand, enforces some rules. I've been using Scrum for quite a while with good programming practices that you find in XP.
...
There are multiple software options to track and plan teams' work. I've been using [Jira](https://www.atlassian.com/software/jira), but there are similar tools available. You should really consider something that allows you to track progress and [Trello](https://trello.com/) is not great for past activities.
